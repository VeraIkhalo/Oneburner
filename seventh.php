  ...
  <div class="dropbtn"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="third.php">Contact Sales<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="fourth.php">Login</a>
      </li>
    </ul>
  </div>
</nav>

<section class="my-15"style="padding-top:300px">
    <h1 class="text-center">THANK YOU FOR REACHING OUT!</h1>
</section>   
